package com.vprserver.password;
...
public class PasswordCodes {
    ...
    public static String getPWcodes() {
    	File dir = new File(GlobalConstant_server.SPATH + "/voicedata");
    	int w = 200, h = 80;
    ...
    public static void main(String[] args) throws IOException{
        File dir = new File("/home/taotao/Documents");
        int w = 200, h = 80;
        for(int i = 0; i < 50; i++){
            String verifyCode = generateVerifyCode(4);

...
if [ -d "./data/$username/enroll" ];then
	rm -rf ./data/$username/enroll
fi
...
datadir=`pwd`/data/$username/enroll
logdir=`pwd`/data/$username/enroll/log
featdir=`pwd`/data/$username/enroll/feat
